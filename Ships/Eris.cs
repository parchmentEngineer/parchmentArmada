...
namespace parchmentArmada.Ships
{
    internal class Eris : ISpriteManifest, IShipPartManifest, IShipManifest, IStartershipManifest, IArtifactManifest, ICardManifest, IDeckManifest, IGlossaryManifest
    {
        ...
        public string Name => "parchment.armada.eris";
        ...
        public static ExternalCard? ErisStrifeEngineCard { get; private set; }
        public static ExternalCard? ErisStrifeForgeCard { get; private set; }
        public static ExternalCard? ErisAnerisCard { get; private set; }
        public static ExternalDeck? ErisDeck { get; private set; }
        public static ExternalGlossary? ErisStrifeEngineGlossary { get; private set; }
        public static ExternalGlossary? ErisAnerisGlossary { get; private set; }
        ...
        {
            artifacts.Add(name,new ExternalArtifact(artifact, "parchment.armada."+name, sprites[art], null, new ExternalGlossary[0]));
        ...
        {
            ErisStrifeEngineCard = new ExternalCard("parchment.armada.ErisStrifeEngineCard", typeof(Cards.ErisStrifeEngineCard), ExternalSprite.GetRaw((int)Spr.cards_GoatDrone), ErisDeck);
            ErisStrifeEngineCard.AddLocalisation("Strife\nEngine");
            registry.RegisterCard(ErisStrifeEngineCard);

            ErisStrifeForgeCard = new ExternalCard("parchment.armada.ErisStrifeForgeCard", typeof(Cards.ErisStrifeForgeCard), ExternalSprite.GetRaw((int)Spr.cards_GoatDrone), ErisDeck);
            ErisStrifeForgeCard.AddLocalisation("Strife\nForge");
            registry.RegisterCard(ErisStrifeForgeCard);

            ErisAnerisCard = new ExternalCard("parchment.armada.eris.aneris", typeof(Cards.ErisAnerisCard), ExternalSprite.GetRaw((int)Spr.cards_GoatDrone), ErisDeck);
