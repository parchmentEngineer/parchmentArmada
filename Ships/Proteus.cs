...
namespace parchmentArmada.Ships
{
    internal class Proteus : ISpriteManifest, IShipPartManifest, IArtifactManifest, IShipManifest, IStartershipManifest, ICardManifest, IGlossaryManifest, IDeckManifest
    {
        ...
        {
            artifacts.Add(name, new ExternalArtifact(artifact, "parchment.armada.proteus." + name, sprites[art], null, new ExternalGlossary[0]));
        ...
        {
            cards.Add(name, new ExternalCard("parchment.armada.proteus." + name, card, ExternalSprite.GetRaw((int)Spr.cards_colorless), ProteusDeck));
        ...
        {
            var patch_target = typeof(Card).GetMethod("RenderAction", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public ) ?? throw new Exception("Couldnt find RenderAction method");
            var patch_method = typeof(Proteus).GetMethod("ProteusIconPatch", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic) ?? throw new Exception("Couldnt find Proteus method");
            harmony.Patch(patch_target, postfix: new HarmonyMethod(patch_method));

            var patch_target_2 = typeof(Ship).GetMethod("DrawTopLayer", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
            var patch_method_2 = typeof(Proteus).GetMethod("ProteusHullPatch", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
            harmony.Patch(patch_target_2, postfix: new HarmonyMethod(patch_method_2));

            var patch_target_3 = typeof(AEndTurn).GetMethod("Begin", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
            var patch_method_3 = typeof(Proteus).GetMethod("ProteusEndTurnMutate", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
        ...
        private static void ProteusEndTurnMutate(G g, State s, Combat c)
        {
            foreach(Card card in c.hand)
            {
                if( typeof(ProteusMutator) == card.GetType())
                {
                    ...
                    c.Queue(new AExhaustOtherCard { card = card });
                    //c.hand.Remove(card);
